# VNC Chrome Docker - Multi-Account Browser Management System
...
- **多账户管理**：支持创建和管理多个独立的Firefox浏览器实例
- **独立配置文件**：每个账户拥有独立的Firefox配置文件
- **代理支持**：支持HTTP、HTTPS和SOCKS5代理配置
- **自动启动**：支持设置账户自动启动
- **远程访问**：通过VNC或noVNC进行远程访问
- **Web管理界面**：提供直观的Web界面进行账户管理
- **日志管理**：完善的日志记录和管理功能
...
可以设置账户在系统启动时自动运行，方便维护长期运行的浏览器实例。
